#!/usr/bin/env python3
"""
Re-evaluate knowledge models with improved system prompts for description generation.
"""
...
def prepare_knowledge_test():
    """Prepare knowledge test samples with system prompt."""
...
def evaluate_knowledge_models():
    ...
    print("╔═══════════════════════════════════════════════════════════════════════════╗")
    print("║         RE-EVALUATING KNOWLEDGE MODELS WITH SYSTEM PROMPTS               ║")
    print("╚═══════════════════════════════════════════════════════════════════════════╝")
    print("")
    ...
    output_file = "/home/evaluation_results_knowledge_with_system_prompt.json"
