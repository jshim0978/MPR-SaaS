...
echo "🚀 Starting Llama 3.1 8B PAWS-Only Fine-tuning"
echo "=========================================="
...
llamafactory-cli train /home/configs/dataset_comparison/8b_paws_only.yaml 2>&1 | tee /home/llama31_8b_paws_only_training.log

echo ""
echo "=========================================="
echo "✅ Training completed!"
echo "📁 Model saved to: /home/models/llama31_8b_paws_only_lora"
echo "=========================================="
