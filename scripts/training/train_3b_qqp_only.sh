...
echo "🚀 Starting Llama 3.2 3B QQP-Only Fine-tuning"
echo "=========================================="
...
llamafactory-cli train /home/configs/dataset_comparison/3b_qqp_only.yaml 2>&1 | tee /home/llama32_3b_qqp_only_training.log

echo ""
echo "=========================================="
echo "✅ Training completed!"
echo "📁 Model saved to: /home/models/llama32_3b_qqp_only_lora"
echo "=========================================="
