...
echo "🚀 Starting Llama 3.1 8B Knowledge Enhancement Fine-tuning"
echo "=========================================="
...
llamafactory-cli train /home/configs/knowledge/8b_knowledge.yaml 2>&1 | tee /home/llama31_8b_knowledge_training.log

echo ""
echo "=========================================="
echo "✅ Training completed!"
echo "📁 Model saved to: /home/models/llama31_8b_knowledge_lora"
echo "📊 Logs saved to: /home/llama31_8b_knowledge_training.log"
echo "=========================================="
