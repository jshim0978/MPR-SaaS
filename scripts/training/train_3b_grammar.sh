...
echo "🚀 Starting Llama 3.2 3B LoRA Fine-tuning"
echo "=========================================="
...
llamafactory-cli train /home/configs/grammar/3b_grammar_jfleg.yaml 2>&1 | tee /home/llama32_3b_lora_training.log

echo ""
echo "=========================================="
echo "✅ Training completed!"
echo "📁 Model saved to: /home/models/llama32_3b_lora_factory"
echo "📊 Logs saved to: /home/llama32_3b_lora_training.log"
echo "=========================================="
